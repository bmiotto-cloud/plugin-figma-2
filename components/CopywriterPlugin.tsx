...
import svgPaths from "../imports/svg-4edodfxcf9.ts";
...
import { projectId, publicAnonKey } from "../supabase/supabaseClient.ts";
...
export function CopywriterPlugin({ onClose, initialText = '', onApplyText, onNotify, nodeInfo, user }: CopywriterPluginProps) {
