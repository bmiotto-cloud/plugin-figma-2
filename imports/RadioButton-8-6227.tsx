import svgPaths from "./svg-b12xx2q6im";
...
function Frame49796() {
  return (
    <div className="bg-[rgba(219,240,255,0.5)] min-w-[335px] relative rounded-[16px] shrink-0 w-full">
      <div className="flex flex-row items-center min-w-inherit overflow-clip relative size-full">
        <div className="box-border content-stretch flex items-center justify-between min-w-inherit px-[12px] py-[16px] relative w-full">
          <Frame14 />
        </div>
      </div>
    </div>
      ...
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex gap-[4px] items-start pb-0 pt-[8px] px-[8px] relative size-full">
          <div className="basis-0 flex flex-col font-['Aeonik_Pro:Regular',_sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px overflow-ellipsis overflow-hidden relative shrink-0 text-[#7a7c84] text-[14px] text-nowrap">
            <p className="[white-space-collapse:collapse] leading-[20px] overflow-ellipsis overflow-hidden">Enter changes description...</p>
          </div>
        </div>
      </div>
...
function Frame7() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[152px] items-center px-0 py-[8px] relative shrink-0 w-full">
      <Textarea />
    </div>
  );
}
