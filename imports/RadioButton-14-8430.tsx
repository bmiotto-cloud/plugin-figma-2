import svgPaths from "./svg-z6ki51jxuz";
...
function Frame8() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center justify-center px-0 py-[32px] relative rounded-[8px] shrink-0 w-full">
      ...
      <ArrowSelectorTool />
      <div className="flex flex-col font-['Aeonik_Pro:Regular',_sans-serif] font-normal justify-end leading-[0] relative shrink-0 text-[#7a7c84] text-[14px] text-nowrap">
...
function ActionButton1() {
  return (
    <div className="bg-[#f5f5f7] box-border content-stretch flex gap-[4px] h-[40px] items-center justify-center overflow-clip px-[16px] py-[12px] relative rounded-[8px] shrink-0" data-name="Action Button">
