import svgPaths from "./svg-kiqimkx7x2";
...
function OutlinedKeyboardArrowUp() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Outlined / keyboard_arrow_up">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
  ...
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#3e4242] text-[14px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">Casual</p>
      </div>
    </div>
  );
}
...
function Chip() {
  return (
    <div className="bg-[#f5f5f7] box-border content-stretch flex h-[32px] items-center justify-center px-[12px] py-0 relative rounded-[20px] shrink-0" data-name="Chip">
      <Frame14181 />
    </div>
  );
}
...
function Frame14182() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#3e4242] text-[14px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">Regular</p>
      </div>
    </div>
  );
}
...
function Chip1() {
  return (
    <div className="bg-[#e2bdff] box-border content-stretch flex h-[32px] items-center justify-center px-[12px] py-0 relative rounded-[20px] shrink-0" data-name="Chip">
      <OutlinedCheck />
      <Frame14182 />
    </div>
  );
...
function Frame14183() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#3e4242] text-[14px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">Professional</p>
      </div>
    </div>
  );
}
...
function Frame14184() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#3e4242] text-[14px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">Shorter</p>
      </div>
    </div>
  );
}
...
function Frame14185() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#3e4242] text-[14px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">Same legth</p>
      </div>
    </div>
  );
}
...
function Frame14186() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#3e4242] text-[14px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">Longer</p>
      </div>
    </div>
  );
}
...
function Frame14187() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#3e4242] text-[14px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">B2B</p>
      </div>
    </div>
  );
}
...
function Frame14188() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#3e4242] text-[14px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">B2C</p>
      </div>
    </div>
  );
}
