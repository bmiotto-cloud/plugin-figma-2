import svgPaths from "./svg-m3r20qtjkz";
...
function Frame6() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex flex-col gap-[8px] items-start ml-0 mt-0 pb-0 pt-[16px] px-[16px] relative w-[312px]">
      <Frame8 />
      <Frame9 />
    </div>
  );
  ...
  return (
    <div className="bg-[#5e2f82] box-border content-stretch flex gap-[4px] h-[40px] items-center justify-center overflow-clip px-[16px] py-[12px] relative rounded-[8px] shrink-0" data-name="Action Button">
      <div className="font-['Aeonik_Pro:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[14px] text-nowrap text-white">
        <p className="leading-[20px] whitespace-pre">Include</p>
      </div>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex gap-[10px] items-center justify-end ml-0 mt-[376px] p-[16px] relative w-[312px]">
